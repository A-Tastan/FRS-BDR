...
%% Representation (FRS-BDR) method for subspace clustering
%
% For details, see:
%
...
%       c_hat           :(numeris) a label vector of size (N-N_{o_I}) x 1
...
%% FRS-BDR algorithm for known number of clusters
[W_block_hat,v_dddot_hat,W_sim_hat,bsize_vec_hat,error] = perform_FRS_BDR_algorithm_knownK(X,K,K_max,N_cmax);

%% Perform subspace clustering
c_hat = spectral_clustering(W_block_hat,K); % the labels are based on the estimated order in Step 1.2
